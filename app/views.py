...
def insert_bank(self):
    with open('C:\\Users\\CHAMU\\Desktop\\djangoprojects\\chamu\\Scripts\\CSV\\app\\bank.csv','r') as FO:
        IOD=csv.reader(FO)
        for i in IOD:
            bn=i[0].strip()
...
def insert_branch(self):
    with open('C:\\Users\\CHAMU\\Desktop\\djangoprojects\\chamu\\Scripts\\CSV\\app\\branch1.csv','r') as FO:
        IOD=csv.reader(FO)
        for i in IOD:
            bn=i[0]
